...
const InvasiveSpeciesMainPart = () => {
  ...
  const addDisease = async(e) => {
    try{
      const userdata= await addDoc(collection(db, "invasive"), {
  ...
  const handlPrediction= async(e)=>{
    ...
    const prediction = await model_predict(base64, "invasive_species")
    ...
    <>
      ...
      <div className='main flex lg:flex-row flex-col    justify-between mt-10 lg:mt-5'>
       <div className="model flex flex-col  justify-center items-center  lg:w-[950px]  lg:h-[600px] border-solid border-[2px] lg:m-3 m-5 ">
         <h1 className='lg:text-2xl text-1xl mb-10  font-bold'>Upload image to detect invasive species</h1>
...
export default InvasiveSpeciesMainPart