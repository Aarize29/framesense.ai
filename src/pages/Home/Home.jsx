...
const Home = () => {
  ...
  return (
    <div className='container mx-auto px-5 my-10'>
      ...
      <div className='flex flex-col justify-center items-center mt-20'>
      <hr className="border-0 w-1/2 h-1 bg-white shadow" style={{ boxShadow: "0px 0px 5px #14b8a6" }} />
      <h1 className='mb-10 text-3xl md:text-3xl lg:text-4xl font-extrabold leading-none tracking-tight text-gray-900   dark:text-black m-4 mt-10 '>Invasive Plant Detection</h1>
      <hr className="border-0 w-1/2 h-1 bg-white shadow" style={{ boxShadow: "0px 0px 5px #14b8a6" }} />
      </div>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-8 items-center mt-12'>
        <div>
          <img src={invasive} alt='invasive' className='rounded-3xl shadow-emerald-300 shadow-md border-2 mx-auto' />
        </div>
        <div className='flex flex-col justify-center'>
          <p className='text-lg lg:text-xl font-normal text-gray-500 dark:text-gray-400'>Detection of invasive plants in agriculture fields is a crucial task for maintaining the productivity and sustainability of crop yields. Invasive plant species can outcompete native plants, reduce biodiversity, and cause economic losses. My app, Farmsense AI, uses advanced image recognition technology to detect and classify invasive plants in real-time. With this technology, farmers can take proactive measures to manage invasive species and prevent further damage to their crops and the environment.</p>
          <div className="card cursor-pointer mt-4">
            <Link to='/invasive'><button className='block mt-4 lg:inline-block lg:mt-0 hover:text-white mr-4  px-6 py-2  text-white bg-[#14b8a6]  rounded-lg hover:bg-[#0f766e]'>Invasive Plant Detection</button></Link>
          </div>
        </div>
      </div>
